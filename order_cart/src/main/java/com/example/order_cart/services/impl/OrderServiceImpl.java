...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public void sendEmail(String email,List<OrderEntity> orderList) throws Exception{
        ...
        for(OrderEntity orderEntity: orderList)
        {
            ...
            String thread = "<p>"+"Email Id : "+orderEntity.getCustomerEmail()+"</p>"+"<p>"+"order Id: "+orderEntity.getOrderId()+"</p>"+"<p>"+"Address : "+orderEntity.getAddress()+"</p>"+"<p>"+"Date :"+orderEntity.getDate()+"</p>";
